...
<div id="main" class="alt">
  ...
  <div class="row">
    <div class="6u 12u$(small)">
      <h3>Jeong, Yonghun</h3>
      <h4>Experience</h4>
      <p><span class="image left"><img src="{% link assets/images/me.jpg %}" alt="" /></span>프리랜서로 일하면서 주로 1인 개발로 프로젝트를 많이 진행 했습니다. 프로젝트 관리, 기획, 클라이언트와의 커뮤니케이션 등 프로젝트 진행과 개발 모두 참여해 본 경험이 있습니다. 최근 2, 3년 동안에는 다른 팀이나 회사와 협업해서 프로젝트를 하게 된 경험들을 하게 되었습니다.</p>
      <h4>Contact</h4>
      <ul>
